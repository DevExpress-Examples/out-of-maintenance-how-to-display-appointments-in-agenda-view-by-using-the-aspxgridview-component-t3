...
#Region "Properties"
        ...
        Public Property ShowResources() As Boolean
            Get
                ...
                Return DirectCast(Session("ShowResources"), Boolean)
            End Get
...
#Region "methods"
        ...
        Private Sub GenerateAgndaViewCaption()
            ...
            ElseIf ShowResources Then
                ...
                Else
                    GridControlAppointments.Caption = String.Format("{0} ({1})", currentMonth, resourceCaption)
                End If
        ...
        Private Sub GoToPreviousMonth()
            ...
            GridControlAppointments.ExpandAll()
        End Sub
        Private Sub GoToSpecificDate(ByVal [date] As Date)
            Dim intervalStart As New Date([date].Year, [date].Month, 1)
            Dim interval As New TimeInterval(intervalStart, intervalStart.AddMonths(1))
...
#Region "events"
            ...
            Select Case commandName
                ...
                Case "SelectedInterval"
                    If calendar.Value IsNot Nothing Then
                        Dim dt As Date = Convert.ToDateTime(calendar.Value)
                        GoToSpecificDate(dt)
                    End If
                    Exit Select
            End Select
        ...
        Protected Sub GridControlAppointments_HtmlRowPrepared(ByVal sender As Object, ByVal e As ASPxGridViewTableRowEventArgs)
            ...
            If label IsNot Nothing Then
                e.Row.BackColor = DirectCast(label, Color)
            End If
        End Sub
#End Region
    End Class
